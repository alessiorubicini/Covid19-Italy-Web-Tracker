...
fetch('https://raw.githubusercontent.com/pcm-dpc/COVID-19/master/dati-json/dpc-covid19-ita-andamento-nazionale.json')
    ...
    .then((data) => {
        ...
        let chart_data = [["Giorno", "Totale terapie"]];
        let day;
        ...
        for (let i = 0; i < jsonData.length; i++) {
            ...
            if(day[2] == '01' || day[2] == '07' || day[2] == '14' || day[2] == '21' || day[2] == '28') {
                ...
                chart_data.push([String(day[2] + "/" + day[1]), jsonData[i]["terapia_intensiva"]])
        ...
        function drawChart() {
            ...
            var chart = new google.visualization.LineChart(document.getElementById('andamento-terapie'));
